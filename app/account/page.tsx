...
export default async function AccountPage() {
  ...
  <p className="text-sm text-muted-foreground">Manage your subscription and access palette exports.</p>
        {tier === 'free' ? (
  ...
  <p className="text-sm text-muted-foreground">Install Colrvia for a faster, app-like experience.</p>
        <PWABadge />
      </section>
      <section className="rounded-2xl border border-linen bg-surface p-6 shadow-soft space-y-4">
        <h2 className="font-medium">Accessibility & Motion</h2>
  <p className="text-sm text-muted-foreground">Control motion intensity for reduced animation.</p>
