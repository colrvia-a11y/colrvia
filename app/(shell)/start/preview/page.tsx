  ...
  return (
    <main className="max-w-2xl mx-auto px-4 py-12 space-y-8">
      <header>
        ...
        <p className="text-sm text-[var(--ink-subtle)]">First pass palette & placements (placeholder). Save to finalize.</p>
      </header>
      <div className="rounded-2xl border p-6 bg-[var(--bg-surface)] text-sm text-[var(--ink-subtle)]">Palette preview coming soon.</div>
