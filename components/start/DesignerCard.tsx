...
export default function DesignerCard({ designer, active, onSelect }: Props){
  ...
  <div className="font-medium mb-1 flex items-center gap-2">{designer.name}<span className="text-[10px] uppercase tracking-wide text-muted-foreground">{designer.headline}</span></div>
  <p className="text-[11px] leading-relaxed text-muted-foreground mb-4 min-h-[2.5rem]">{designer.blurb}</p>
